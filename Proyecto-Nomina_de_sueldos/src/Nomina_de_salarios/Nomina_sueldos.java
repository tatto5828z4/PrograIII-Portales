...
public class Nomina_sueldos {
    ...
    /**
     * (cant):Cantidad ingresada por el usuario (cantaux):Cantidad de empleados
     * que contiene mi archivo que se le suma a mi vector y matriz
     */
     ...
     * nombre[]):Contiene nombres de los empleados. (puesto[]):Contiene puestos
     * de los empleados
     */
    ...
    public void IngresoDatos(float Nomina_salariosArray[][], String nombre[], String puesto[]) {
        ...
        try {
             ...
             *
             * longitud : este es el número de elementos de matriz que se
             * copiarán.
             */
            ...
            /**
             * for para que Nomina_salariosArray[][] se valla haciendo mas
             * grande
             */
            ...
            for (int i = 0; i < cant + cantaux; i++) {
                ...
                for (int j = 0; j < 13; j++) {
                    ...
                    System.out.println("\033[33m" + Nomina_salarios[i][j]);
                }
                System.out.println(" ");
            }
    ...
    /**
     * (ModificarDatos):Metodo de la Clase Nomina_sueldos que sirve para
     * modificar datos que tiene como parametros: (NominaAModificar[][]):Nos a
     * servir para acceder a cualquier dato de nuestra matriz floats tambien
     * para modificarlos (nombre[]):Vector que nos va a servir para acceder a
     * los nombres y para poder modificarlos. (puesto[]):Vector que nos va a
     * servir para acceder a los puestos y para poder modificarlos
     */
    public void ModificarDatos(float NominaAModificar[][], String nombre[], String puesto[]) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, PersonaAModificar + ":  MODIFICADO EN PLANILLA - SE MOSTRARA SUS RESULTADOS EN LA OPSION 2 ", "EMPLEADO MODIFICADO CORRECTAMENTE", JOptionPane.INFORMATION_MESSAGE, Modificado);
    ...
    /**
     * (EliminarDatos()):Metodo de mi clase Nomina_sueldos que nos sirve para
     * eliminar datos que tiene como parametros: (RegistroAEliminar[][]):Se
     * necesita la matriz donde tenemos los datos a eliminar (nombre[]):Se
     * necesita por que tenesmos que eliminar por medio de un nombre y para
     * poder eliminar un nombre tambien (puesto[]):para poder eliminar un puesto
     */
    ...
    /**
     * (int i):retorna la posicion deseada (int Posiciones[]):las posiciones a
     * eliminar y las que no
     */
    ...
    /**
     * (boolean BuscarRegistro):Meotodo de la clase Nomina_sueldos para buscar
     * un Registro tiene como parametro: (NombreAuxiliar):Que nos va a servir
    ...
    /**
     * (void BorraArchivo):Metodo de la Clase Nomina_suledos que sirve para
     * borrar un archivo que tiene como parametro: (NombreArchivo):Que sirve
     * para que elimine el File osea mi archivo.
     */
    ...
    /**
     * (void BorraImagen):Metodo de la Clase Nomina_suledos que sirve para
     * borrar una imagen que tiene como parametro: (NombreImagen):Que sirve para
     * que elimine un png osea mi imagen.
     */
    ...
    /**
     * (void GenerarQR):Metodo para crear un codigo Qr de mi clase
     * Nomina_sueldos que tiene como parametros: (dato): lo que contiene el QR
     * (name): nombre del QR
     */
