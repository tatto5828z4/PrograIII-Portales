...
public class Login {
    ...
    String Correo ="jorgitoskyline@hotmail.com";
 ...
 * */
    ...
    public void Ingreso()
    {
        ...
        if( BuscarRegistroDB(UsuarioAxuParaDB) == false && (UsuarioAxuParaDB.equals("admin") && ContraseñaAxuParaDB.equals("12345"))){
            try {
        ...
        if (UsuarioAxuParaDB.equals(UsuarioaConsultaBD[0]) &&ContraseñaAxuParaDB.equals(UsuarioaConsultaBD[1]))
        {
           try{
            ...
            Mensaje();
            UsuarioBitacora();
            acceder.menu(UsuarioAxuParaDB,ContraseñaAxuParaDB);

        }


            if (!UsuarioAxuParaDB.equals(UsuarioaConsultaBD[0]) || !UsuarioAxuParaDB.equals(UsuarioaConsultaBD[0])){
    ...
    public void RecuperarUser()
    {
        ...
        try
        {
            ...
            if (!auxUsername.equals(usuario) && !aux_Recuperar.equals(recuperar_Password))
            {
                 ...
                 */
                JOptionPane.showConfirmDialog(null, "CORREO ELECTRONICO INCORRECTO");
